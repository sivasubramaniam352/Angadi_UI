        ...
        <Row>
          <Col md='3' lg='3'>
            <ul className={'modal-list'}>
              <li className={'modal-nav-headDisc'}>Topwears</li>
              <li>T-shirt</li>
              <li>shirts</li>
              <li>kurtas</li>
              <li>coats&Blazers</li>
          ...
          <Col md='3' lg='3'>
            <ul className={'modal-list'}>
          <li className={'modal-nav-headDisc'}>BottomWares</li>
              <li>jeans</li>
              <li>trousers</li>
              <li>3/4ths</li>
              <li>Phants</li>
          ...
          <Col md='3' lg='3'>
<ul className={'modal-list'} >
  <li className={'modal-nav-headDisc'}>Footwear</li>
  <li>Casual Shoes</li>
  <li>Sports Shoes</li>
  <li>Formal Shoes</li>
  <li>Sneakers</li>
  ...
  <li>Socks</li>
          ...
          <Col md='3' lg='3'>
            <ul className={'modal-list'}>
              <li className={'modal-nav-headDisc'}>Fashion Accessories</li>
              <li>Wallets</li>
              <li>Belts</li>
